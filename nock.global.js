...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt1860213', tomatoes: 'true'})
  .reply(200, {
    Title: 'Blah',
    Year: '2015',
    Rated: 'R',
    ...
    Runtime: '102 min',
    Genre: 'Drama, Thriller, War',
    Director: 'asdfas asdf',
    Writer: 'asdf sdf (screenplay)',
    Actors: 'asdf Hassan, Aisha Takow, Armaan Haggio, Helen Mirren',
    Plot: 'asdfasdfasdf. Katherine Powell, a military officer in command of an operation to capture terrorists in Kenya, sees her mission escalate when a girl enters the kill zone triggering an international dispute over the implications of modern warfare.',
    Language: 'sdf, English',
    Country: 'asdf, South Africa',
    Awards: '1 nomination.',
    Poster: 'https://images-na.ssl-images-amazon.com/images/M/MV5BNTY4Nzg5MTU0OV5BMl5BanBnXkFtZTgwMjY2MjU2NzE@._V1_SX300.jpg',
    Metascore: '73',
    imdbRating: '7.3',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt2304933', tomatoes: 'true'})
  .reply(200, {
    Title: '1143234324',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt3079380', tomatoes: 'true'})
  .reply(200, {
    Title: 'AFEFSDFasdf',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt0088763', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt0068646', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt3464902', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt1840309', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt0796366', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt1638355', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
...
nock('https://www.omdbapi.com:443', {encodedQueryParams: true})
  .get('/')
  .query({i: 'tt1083452', tomatoes: 'true'})
  .reply(200, {
    Title: '9099099009',
    Year: '2015',
    Rated: 'R',
